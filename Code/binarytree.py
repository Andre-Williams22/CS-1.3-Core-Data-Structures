    ...
    def height(self):
        ...
        # TODO: Check if left child has a value and if so calculate its height
            if self.left is not None:
                lheight = self.left.height() + 1 #leftdepth = self.left.height()
            # TODO: Check if right child has a value and if so calculate its height
            if self.right is not None:
                rheight = self.right.height() + 1 #rightdepth = self.right.height()
...
class BinarySearchTree(object):
    ...
    def _find_node_iterative(self, item):
        ...
        TODO: Best case running time: O(1) under what conditions? The item could be the root node in the tree.
        TODO: Worst case running time: O(log(n)) under what conditions? We traverse through the last child which is bottom of the tree."""
    ...
    def _find_parent_node_iterative(self, item):
        ...
        TODO: Best case running time: O(1) under what conditions? The given item matches the root node
        TODO: Worst case running time: O(log(n)) under what conditions? If we traverse to last level of the tree"""
